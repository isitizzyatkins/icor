...
all charts are separated by rhythm tiers that can be downloaded and played separately. the categories do not represent raw difficulty, they represent rhythmic complexity and my entirely arbitrary and subject feeling of difficulty. if that doesn't make sense, start with tier 1 and move up from there if that's too easy or too boring for you. 
